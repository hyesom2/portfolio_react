      ...
      <div className="fixed top-1/2 left-1/2 z-50 flex h-full max-h-[37.5rem] w-full max-w-[56.25rem] -translate-x-1/2 -translate-y-1/2 transform rounded-r-sm bg-white">
        ...
        <div className="flex w-full flex-col gap-8 p-4">
          <header>
            <Avatar
              type="profile"
              imgURL="/images/pokemon/pokemon.webp"
              name="포켓몬도감 팀 프로젝트"
            />
            <div className="flex flex-col gap-2 pl-12">
              ...
              <ul className="text-insta_link fs-14 flex items-center justify-start gap-2">
                <li>#HTML5</li>
                <li>#JavaScript</li>
                <li>#Axios</li>
              </ul>
          ...
          <ul className="scrollbar-hide flex flex-col gap-7 overflow-scroll">
            <li className="flex items-start justify-start gap-4">
              <Avatar
                imgURL="https://i.namu.wiki/i/1mEwgl9rjQOSNrLd0BztTE7NcPOGnzRxHl_SW_uawAxtnMk9Tdzh3wTwqZK7Q1Q3FENfDJ4yqEmRMiKnTg_wNA.webp"
                name="기여한 일"
              />
              <div>
